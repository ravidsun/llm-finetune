...
Complete step-by-step guides for fine-tuning **Qwen2.5-14B-Instruct** on A40/A100 GPUs.

## Quick Links

- 🚀 **[RunPod Automated Guide](../RUNPOD_GUIDE.md)** - One-command setup and training
- 🤖 **[Model Configuration Guide](MODEL_GUIDE.md)** - 14B model settings and optimization details
...
**Note:** This pipeline is configured exclusively for Qwen2.5-14B-Instruct on GPUs with 40GB+ VRAM.
